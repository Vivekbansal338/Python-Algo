"""
================================================================================
V4 DATA MINER (PHASE 1)
================================================================================
Fetches historical data for Sector Validation.
Scope: Benchmarks, Indices, and ALL Stocks.
Timeframes: Daily (for RS) and 5-minute (for Breadth/Intraday).
...
class DataMiner:
    ...
    def fetch_all(self, days_back: int = 60, force: bool = False):
        ...
        # 2. Indices (Use tokens from JSON)
        ...
        for i, target in enumerate(targets):
            ...
            self._fetch(token, sym, from_date, to_date, "day", DAILY_DIR, force)
            self._fetch(token, sym, from_date, to_date, "5minute", INTRA_DIR, force)
            
            time.sleep(0.1)

    def _fetch(self, token, symbol, from_date, to_date, interval, save_dir, force=False):
        ...
        if existing_df.empty:
            ...
            # No print here, handled by final 'Saved' log
        else:
            ...
            for start, end in fetch_ranges:
                if interval == "5minute" and (end - start).days > 60:
                    ...
                    while curr < end:
                        ...
                        if chunk: new_data.extend(chunk)
