"""
===============================================================================
V6.1 SECTOR BACKTEST ENGINE
===============================================================================
Backtest engine based on V6 with intraday-native risk/target management.

Changes from V6:
- 2.2  Entry Risk Model — Intraday-Native Stop (5m ATR replaces daily ATR)
...
# Enable `python backtest_v6/sector_engine_v6.1.py` from repo root.
...
class SectorBacktesterV6:
    """
    V6 backtester using current V6 production rules with V6.1 risk/target upgrades.
    """
    ...
    def export_trades(self, filepath: Optional[Path] = None):
        out_path = Path(filepath) if filepath else (self.data_root / "backtest_trades_v6.1.csv")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="V6.1 sector backtest engine")
