"""
===============================================================================
V6.4 SECTOR BACKTEST ENGINE — HARD ALIGNMENT FILTER
===============================================================================
...
- V6.4 keeps V6.2's ORIGINAL weights and scoring UNCHANGED.  Instead, it adds
...
# Enable `python backtest_v6/sector_engine_v6.4.py` from repo root.
...
class SectorBacktesterV6:
    """
    V6.4 backtester using V6.2 as base with a hard 3-way alignment filter:
    ...
    def __init__(
        ...
        self.history_dir = self.backtest_root / "history_v6.4"
    ...
    def _print_grand_summary(self):
        ...
        print("\n" + "=" * 80)
        print("V6.4 BACKTEST SUMMARY (HARD ALIGNMENT FILTER)")
        print("-" * 80)
        ...
        if self.trade_history:
            ...
            # V6.4: Hard Alignment Filter — Direction Matrix
    ...
    def export_trades(self, filepath: Optional[Path] = None):
        out_path = Path(filepath) if filepath else (self.data_root / "backtest_trades_v6.4.csv")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="V6.4 sector backtest engine (hard alignment filter)")
