...
from analysis_v5.indicators_v5 import calculate_atr

logger = logging.getLogger("LifecycleV5")
...
class LifecycleManager:
    ...
    def initiate_trade(self, 
        ...
        """
        # 1. Place Entry
        order_id = self.orders.place_entry_order(symbol, direction, qty, entry_price, "V5_ENTRY", sector=sector)
        if not order_id:
            return None
