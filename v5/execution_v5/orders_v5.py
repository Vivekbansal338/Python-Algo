"""
================================================================================
V5 ORDER MANAGER (PAPER TRADING)
================================================================================
...
logger = logging.getLogger("OrdersV5")
...
class OrderManager:
    def __init__(self):
        ...
        if not self.is_paper:
            logger.critical("V5 IS STRICTLY PAPER TRADING. LIVE MODE NOT SUPPORTED.")
            raise RuntimeError("Live Mode Disabled in V5")
