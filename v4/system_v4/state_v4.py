...
from execution_v4.lifecycle_v4 import Trade

logger = logging.getLogger("StateV4")
...
class StateManager:
    ...
    def save_state(self, 
        ...
        try:
            ...
            for tid, trade in lifecycle_manager.trades.items():
                ...
                # Handle new Chandelier timestamp
            ...
            # Need to handle datetime in orders
            serialized_orders = {}
    ...
    def _archive_old_state(self, old_state):
        ...
        archive_path = config.DATA_DIR / f"state_{date_str}.json"
        try:
